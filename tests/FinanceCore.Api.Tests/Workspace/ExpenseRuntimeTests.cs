...
public sealed class ExpenseRuntimeTests : FinanceCoreRuntimeSuite
{
    ...
    public async Task Shows_expense_action()
    {
        ...
        Assert.Equal(["transaction.expense.add", "transaction.income.add", "transaction.recent.show", "summary.month.show", "profile.timezone.show", "account.add"], home.Payload.Frame.Actions);
    }
    /// <summary>
