...
public sealed class WorkspaceActionsTests
{
    ...
    public void Returns_codes_for_home()
    {
        ...
        IReadOnlyList<string> code = item.Codes("home", new WorkspaceActionContext(0, 0, 0, 0, page, false, false));
    ...
    {
        var item = new WorkspaceActions();
        IReadOnlyList<string> code = item.Codes("account.currency", new WorkspaceActionContext(0, 0, 0, 0, page, false, false));
        IReadOnlyList<string> custom = item.Codes("account.currency", new WorkspaceActionContext(0, 0, 0, 0, page, false, true));
    ...
    {
        var item = new WorkspaceActions();
        IReadOnlyList<string> code = item.Codes("home", new WorkspaceActionContext(1, 0, 0, 0, page, false, false));
    ...
    {
        var item = new WorkspaceActions();
        IReadOnlyList<string> account = item.Codes("transaction.expense.account", new WorkspaceActionContext(2, 2, 0, 0, page, false, false));
        IReadOnlyList<string> category = item.Codes("transaction.expense.category", new WorkspaceActionContext(2, 0, 3, 0, page, false, false));
        IReadOnlyList<string> incomeAccount = item.Codes("transaction.income.account", new WorkspaceActionContext(2, 2, 0, 0, page, false, false));
        IReadOnlyList<string> incomeCategory = item.Codes("transaction.income.category", new WorkspaceActionContext(2, 0, 3, 0, page, false, false));
    ...
    {
        var item = new WorkspaceActions();
        Assert.Throws<ArgumentException>(() => item.Codes(string.Empty, new WorkspaceActionContext(0, 0, 0, 0, page, false, false)));
    }
    /// <summary>
    ...
    {
        var item = new WorkspaceActions();
        InvalidOperationException error = Assert.Throws<InvalidOperationException>(() => item.Codes("account.unknown", new WorkspaceActionContext(0, 0, 0, 0, page, false, false)));
